            ...
            <section className="greygradiant text-white" id="myinfo">
                ...
                <div className="container px-5 pb-6">
                    <div className="row gx-5 margin_move_up">
                        ...
                        <div className="col-lg-4 mb-5 mb-lg-0">
                            <div className="feature bg-warning bg-gradient text-white rounded-2 mb-5 margin_l10"><i className="fa-solid fa-trophy text-black"></i></div>
                        ...
                        <div className="col-lg-4">
                            <div className="feature bg-warning bg-gradient text-white rounded-2 mb-5 margin_l10"><i className="fa-solid fa-ticket text-black"></i>  </div>
